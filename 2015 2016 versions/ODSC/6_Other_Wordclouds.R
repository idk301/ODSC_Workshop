...
commonality.cloud(tdm, max.words=150, random.order=FALSE,colors=pal)

#create the comparison word cloud
set.seed(1237)
comparison.cloud(tdm, max.words=150, random.order=FALSE,title.size=1.0,colors=brewer.pal(ncol(tdm),"Dark2"))
